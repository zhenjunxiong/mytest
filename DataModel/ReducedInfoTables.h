...
DECLARE_SOA_COLUMN(PAIRINDEX, pairindex, uint64_t);
...
DECLARE_SOA_TABLE(ReducedTracksBarrelPOSTPID, "AOD", "RTBARRELPOSTPID",
                  reducedtrack::PAIRINDEX);
...
using ReducedTrackBarrelPOSTPID = ReducedTracksBarrelPOSTPID::iterator;
...
//new add
DECLARE_SOA_COLUMN(TPCnSigmaE1, nsigmaE1, float);
DECLARE_SOA_COLUMN(TPCnSigmaPi1, nsigmaPi1, float);
DECLARE_SOA_COLUMN(TPCnSigmaPr1, nsigmaPr1, float);
DECLARE_SOA_COLUMN(V0INDEX1, v0index1, uint64_t);

DECLARE_SOA_COLUMN(TPCnSigmaE2, nsigmaE2, float);
DECLARE_SOA_COLUMN(TPCnSigmaPi2, nsigmaPi2, float);
DECLARE_SOA_COLUMN(TPCnSigmaPr2, nsigmaPr2, float);
DECLARE_SOA_COLUMN(V0INDEX2, v0index2, uint64_t);
...
DECLARE_SOA_COLUMN(QTARMV0, qtarmv0, float);
DECLARE_SOA_COLUMN(V0PAIR, v0pair, int);
//end
...
DECLARE_SOA_TABLE(DileptonsV0, "AOD", "RTDILEPTONV0", //!
                  reducedpair::ALPHAV0,
                  reducedpair::QTARMV0,
                  reducedpair::Sign,
                  reducedpair::V0PAIR,
                  dilepton_track_index::Pt1, dilepton_track_index::Eta1, dilepton_track_index::Sign1,
                  dilepton_track_index::Pt2, dilepton_track_index::Eta2, dilepton_track_index::Sign2,
                  dilepton_track_index::TPCnSigmaE1, dilepton_track_index::TPCnSigmaPi1, dilepton_track_index::TPCnSigmaPr1,
                  dilepton_track_index::TPCnSigmaE2, dilepton_track_index::TPCnSigmaPi2, dilepton_track_index::TPCnSigmaPr2,
                  dilepton_track_index::V0INDEX1,dilepton_track_index::V0INDEX2
                  );
...
using DileptonV0 = DileptonsV0::iterator;
...
DECLARE_SOA_COLUMN(PAIRMARK, pairmark, uint64_t);
} // namespace v0bits
...
DECLARE_SOA_COLUMN(TRACK1_TPCSignal, track1_TPCSignal, float);
DECLARE_SOA_COLUMN(TRACK1_TPCInnerParam, track1_TPCInnerParam, float);
DECLARE_SOA_COLUMN(TRACK1_Signed1Pt, track1_signed1Pt, float);
DECLARE_SOA_COLUMN(TRACK1_Eta, track1_eta, float);
DECLARE_SOA_COLUMN(TRACK1_Phi, track1_phi, float);
DECLARE_SOA_COLUMN(TRACK1_Y, track1_y, float);
DECLARE_SOA_COLUMN(TRACK1_NSigTPC, track1_nsigTPC, float);
DECLARE_SOA_COLUMN(TRACK1_NSigTOF, track1_nsigTOF, float);
DECLARE_SOA_COLUMN(TRACK1_BetaGamma, track1_bg, float);
DECLARE_SOA_COLUMN(TRACK1_Mass, track1_mass, float);
DECLARE_SOA_COLUMN(TRACK1_PidIndex, track1_pidIndexTPC, uint8_t);
DECLARE_SOA_COLUMN(TRACK2_TPCSignal, track2_TPCSignal, float);
DECLARE_SOA_COLUMN(TRACK2_TPCInnerParam, track2_TPCInnerParam, float);
DECLARE_SOA_COLUMN(TRACK2_Signed1Pt, track2_signed1Pt, float);
DECLARE_SOA_COLUMN(TRACK2_Eta, track2_eta, float);
DECLARE_SOA_COLUMN(TRACK2_Phi, track2_phi, float);
DECLARE_SOA_COLUMN(TRACK2_Y, track2_y, float);
DECLARE_SOA_COLUMN(TRACK2_NSigTPC, track2_nsigTPC, float);
DECLARE_SOA_COLUMN(TRACK2_NSigTOF, track2_nsigTOF, float);
DECLARE_SOA_COLUMN(TRACK2_BetaGamma, track2_bg, float);
DECLARE_SOA_COLUMN(TRACK2_Mass, track2_mass, float);
DECLARE_SOA_COLUMN(TRACK2_PidIndex, track2_pidIndexTPC, uint8_t);
DECLARE_SOA_COLUMN(TRACK1_V0Index, track1_v0IndexTPC, uint64_t);
DECLARE_SOA_COLUMN(TRACK2_V0Index, track2_v0IndexTPC, uint64_t);
}//v0tree namespace
DECLARE_SOA_TABLE(myv0tree, "AOD", "MYV0TREE",
                  v0tree::AlphaV0,
                  v0tree::QtV0,
                  v0tree::CosPAV0,
                  v0tree::PtV0,
                  v0tree::RadiusV0,
                  v0tree::TRACK1_TPCSignal,
                  v0tree::TRACK1_TPCInnerParam,
                  v0tree::TRACK1_Signed1Pt,
                  v0tree::TRACK1_Eta,
                  v0tree::TRACK1_Phi,
                  v0tree::TRACK1_NSigTPC,
                  v0tree::TRACK1_NSigTOF,
                  v0tree::TRACK1_Mass,
                  v0tree::TRACK2_TPCSignal,
                  v0tree::TRACK2_TPCInnerParam,
                  v0tree::TRACK2_Signed1Pt,
                  v0tree::TRACK2_Eta,
                  v0tree::TRACK2_Phi,
                  v0tree::TRACK2_NSigTPC,
                  v0tree::TRACK2_NSigTOF,
                  v0tree::TRACK2_Mass,
                  v0tree::TRACK1_V0Index,
                  v0tree::TRACK2_V0Index
                );
} //namespace o2::aod
